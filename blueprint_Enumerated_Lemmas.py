...
def create_enumerated_lemma():
    ...
    new_enumerated_lemma = Enumerated_Lemmas(enumerated_lemma=enumerated_lemma, 
...
def get_all_enumerated_lemmas():
    ...
    return jsonify(enumerated_lemmas=[enumerated_lemma.__dict__ for enumerated_lemma in all_enumerated_lemmas])

@enumerated_lemmas.route('/<enumerated_lemma>', methods=['PUT'])
def update_enumerated_lemma(enumerated_lemma):
    data = request.json
    existing_lemma = Enumerated_Lemmas.query_by_enumerated_lemma(enumerated_lemma)
    if existing_lemma:
